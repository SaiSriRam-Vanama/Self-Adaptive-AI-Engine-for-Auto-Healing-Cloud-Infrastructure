...
- ⚠️ **Risk prediction engine** — Weighted scoring + linear trend analysis forecasts future risk levels (Low / Medium / High)
...
- 🖥️ **Live PyQt5 dashboard** — Real-time graphs (pyqtgraph), snapshot bar charts (matplotlib), server metrics tables, and scrollable log viewer
...
### ⌨️ CLI Mode (Headless Monitoring)
...
├── ⚙️ config.py               # Central configuration (servers, thresholds)
...
*Built with ❤️ using Python, PyQt5, and Machine Learning*
